...
## zdroj  :http://christophergandrud.blogspot.sk/2015/05/a-link-between-topicmodels-lda-and.html
## data z lda_topicmodels_exmpl.R
# uncomment and run
# json<-topicmodels_json_ldavis(fitted = ldaOut, corpus = docs, doc_term = dtm)
# serVis(json)
